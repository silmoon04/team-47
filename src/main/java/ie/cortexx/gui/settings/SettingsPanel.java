...
public class SettingsPanel extends JPanel {
    ...
    private JPanel buildMerchant() {
        ...
        form.add(UI.field("Business Name", new JTextField("Cosymed Ltd")));
        form.add(UI.gap(8));
        form.add(UI.formRow(
            UI.field("Contact Name", new JTextField("Alex Wright")),
            UI.field("Phone", new JTextField("0207 321 8001"))
        ));
        form.add(UI.field("Address", new JTextField("25 Bond Street, London WC1V 8LS")));
        form.add(UI.gap(8));
        form.add(UI.formRow(
        ...
        form.add(UI.gap(12));
        form.add(UI.primaryButton("Save Changes"));
